...
void main()async {
 ...
 userBox =  await Hive.openBox<UserModel>(Config.dbName);
  ...
  runApp(MultiProvider(providers: providersList,
    child: const MyApp()));
}
            ...
            ? ScreenUtilInit(designSize: const Size(333,675),
              child: CupertinoApp(
                  ...
                  theme:  CupertinoThemeData(
                      barBackgroundColor:KColors().kWhite, primaryColor: Colors.black),
            ...
            : ScreenUtilInit(designSize: const Size(333,675),child: MaterialApp(
                ...
                theme: ThemeData.light().copyWith(
                  searchBarTheme: SearchBarThemeData(
                      backgroundColor: MaterialStateProperty.all(KColors().kWhite)),
                ))
                );
  }
}
